...
export const getStaticProps = async () => {
  ...
  const path = String(`https://alcoban-vbk7q.ondigitalocean.app/Orders/orderType/Delivered/`)
...
export default function DeliveredOrders({OrderDetails}) {
    ...
    <>
      ...
      >
        ...
        <Grid
          ...
          xl={8}
        >
          <MainOrderFn orders ={ OrderDetails} gettingOrderData = {updateOrderStatus} />
        </Grid>
      </Grid>
    </>
  );
